    ...
    return (
        <section id="home" className="min-h-screen flex items-center justify-center relative">
            ...
            <div className="text-center z-10 px-4">
                ...
                Hi there! Buckle up and welcome to my digital wonderland!<br></br>
                I'm an IT Support & Frontend Development specialist who loves solving problems, keeping systems running smoothly and building intuitive user interfaces.<br></br>
